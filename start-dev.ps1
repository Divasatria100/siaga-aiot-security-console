...
# ============================================
# SIAGA - Development Environment Starter
...
Write-Host "[3/5] Starting SIAGA containers..." -ForegroundColor Yellow
Write-Host ""
...
if ($LASTEXITCODE -ne 0) {
    Write-Host ""
    Write-Host "[ERROR] Failed to start SIAGA containers." -ForegroundColor Red
    exit $LASTEXITCODE
}
...
Write-Host "[4/5] Checking backend container..." -ForegroundColor Yellow
...
Write-Host "SIAGA Development Environment" -ForegroundColor Green
Write-Host "--------------------------------------------" -ForegroundColor Green
Write-Host "  Frontend    : http://localhost:5173" -ForegroundColor Gray
Write-Host "  API         : http://localhost:8000/api/v1" -ForegroundColor Gray
Write-Host "  PostgreSQL  : localhost:5432 (siaga_db, TimescaleDB)" -ForegroundColor Gray

Write-Host ""
Write-Host "Useful commands:" -ForegroundColor White
Write-Host "  Migration   : .\migrate.ps1" -ForegroundColor Gray
Write-Host "  Reset DB    : .\migrate.ps1 -Fresh" -ForegroundColor Gray
